...
def find_qualifying_loans(bank_data, credit_score, debt, income, loan, home_value):
    ...
    format_monthly_debt_ratio = "{:.2f}".format(monthly_debt_ratio)
    print( "The monthly debt to income ratio is", format_monthly_debt_ratio)
    

    # Calculate loan to value ratio
    loan_to_value_ratio = calculate_loan_to_value_ratio(loan, home_value)
    format_loan_to_value_ratio = "{:.2f}".format(loan_to_value_ratio)
    print( "The loan_to_value_ratio is", format_loan_to_value_ratio)
    ...
    print("Found " + str({len(bank_data_filtered)}) + " qualifying loans")
...
if __name__ == "__main__":
    fire.Fire(run)
    #fire.Fire(save_qualifying_loans(["123", "1233", "12312"]))
